...
public class GamePanel extends JPanel implements KeyListener, ActionListener {
  ...
  private String currentMapName = "Unknown"; // Tracks current active map name
  ...
  public void loadMap(MapData mapData) {
    this.currentMapName = mapData.mapName; // Inherit map name context from reader
    progress = 0;
    moves = 0;
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getSource() == animationTimer) {
      ...
      if (!solutionThread.isAlive()) {
        ...
        // --- ADDED REVISED CSV LOGGER FOR SUCCESSFUL SOLVES HERE ---
        long finalTimeNano = System.nanoTime() - solutionStartTime;
        double timeSecs = finalTimeNano / 1000000000.0;
        CSVLogger.logResult(this.currentMapName, solution.length(), timeSecs, true);
        // -----------------------------------------------------------
      ...
      // --- ADDED REVISED CSV LOGGER FOR TIMEOUTS (FAILS) HERE ---
      CSVLogger.logResult(this.currentMapName, 0, 15.00, false);
      // ----------------------------------------------------------
